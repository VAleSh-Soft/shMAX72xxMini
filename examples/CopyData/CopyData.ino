 ...
 * 
 * Пример считывания данных из буфера устройства и вывод его на другое устройство; 
 * в этом примере данные выводятся на первое и второе устройства каскада, после
 * чего копируются на третье и четвертое устройства; при копировании учитываются 
 * заданные для матрицы поворот и отражение изображения;
 * 
 */
