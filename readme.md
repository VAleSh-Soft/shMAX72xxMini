...
Работа с интерфейсом, отличным от интерфейса по умолчанию (**SPI**), тестировалась на **ATmega328pb**, **esp32**, **esp32s2**, **esp32s3**, **rp2040**, **stm32f103c8t6** (**Blue Pill**), **stm32f401ccu6** (**Black Pill**), **stm32f411ceu6** (**Black Pill**), **stm32f411ceu6** (**Black Pill**). 
