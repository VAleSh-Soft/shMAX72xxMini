...
+ добавлены примеры одновременного использования двух **SPI**-интерфейсов на примере одновременного вывода двух бегущих строк; примеры написаны для **ESP32** и **RP2040**;
