...
На данный момент библиотека тестировалась в работе на **ATmega168p/328p/328pb**, **esp8266**, **esp32**, **esp32c3**, **esp32s2**, **esp32s3**, **rp2040** (**Zero** и **Pico**), **stm32f103c8t6** (**Blue Pill**), **stm32f401ccu6** (**Black Pill**). 

Работа с интерфейсом, отличным от интерфейса по умолчанию (**SPI**), тестировалась на **ATmega328pb**, **esp32**, **esp32s2**, **esp32s3**, **rp2040**, **stm32f103c8t6** (**Blue Pill**), **stm32f401ccu6** (**Black Pill**). 
