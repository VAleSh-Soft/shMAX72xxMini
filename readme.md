...
Интерфейс **HSPI** для этого МК в среде **Arduino IDE** недоступен, однако можно запустить второй **FSPI**-интерфейс; работа драйвера с двумя интефейсами тестировалась на следующих пинах второго **FSPI**-интерфейса:
