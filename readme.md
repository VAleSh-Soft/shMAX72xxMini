...
Интерфейс **HSPI** для этого МК в среде **Arduino IDE** недоступен (смотри https://github.com/espressif/arduino-esp32/issues/7596), однако можно запустить второй **FSPI**-интерфейс; работа драйвера с двумя интефейсами тестировалась на следующих пинах второго **FSPI**-интерфейса:
